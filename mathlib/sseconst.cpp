...
#ifndef _X360
#pragma push_macro( "Four_Zeros" )
#pragma push_macro( "Four_Ones" )
#undef Four_Zeros
#undef Four_Ones
extern const fltx4 Four_Zeros={0.0,0.0,0.0,0.0};
extern const fltx4 Four_Ones={1.0,1.0,1.0,1.0};
#pragma pop_macro( "Four_Zeros" )
#pragma pop_macro( "Four_Ones" )
#endif

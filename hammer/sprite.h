...
public:
	...
	inline void SetTextureExtent( const Vector2D& TexUL, const Vector2D& TexLR ) { m_TexUL = TexUL; m_TexLR = TexLR; }
	inline void SetExtent( const Vector2D& UL, const Vector2D& LR ) { m_UL = UL; m_LR = LR; }

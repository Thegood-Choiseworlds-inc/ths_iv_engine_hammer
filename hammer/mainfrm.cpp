...
BEGIN_MESSAGE_MAP(CMainFrame, CMDIFrameWnd)
	...
	ON_COMMAND(ID_TOOLS_IO_EDITOR, &ThisClass::OnIOEditor)
...
void CMainFrame::OnIOEditor()
{
#if 0
	CIOEditor editor( APP()->m_pMainWnd );
	editor.Show();
	editor.DoModal();
#endif
}
...
void CMainFrame::UpdateTextureWindows()
{
	m_pFaceEditSheet->m_MaterialPage.UpdateTextureList();
	m_TextureBar.UpdateTextureList();
}
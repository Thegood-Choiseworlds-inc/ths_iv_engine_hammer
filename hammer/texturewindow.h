...
public:
	...
	void Create(CWnd *pParentWnd, const RECT& rect);
...
protected:
	...
	BOOL bFirstPaint;
	CFont TexFont;
	CUsedTextureList *m_pSpecificList;
	CRect rectHighlight;
	int	m_nTypeFilter;

...
protected:
	void UpdateColorFilter( COLORREF clr );
	...
	public:
		...
		void Setup( UINT nID, CWnd* parent );

		void UpdateColor( COLORREF color ) override;

		CArray<COLORREF, COLORREF>& ColorList() { return m_Colors; }
	};
	...
	CButton m_FilterColor;
	CButton m_ShowErrors;
	CColorButton m_ColorFilter;

	CUsedTextureList m_TextureSubList; // Holds a specific sublist of textures to browse.
};

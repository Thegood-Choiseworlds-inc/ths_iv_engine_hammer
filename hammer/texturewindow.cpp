...
constexpr const int iPadding = 4;
constexpr const int iTexNameFontHeight = 7;
constexpr const int iTexIconHeight = 12;
...
//			rect -
//-----------------------------------------------------------------------------
void CTextureWindow::Create(CWnd *pParentWnd, const RECT& rect)
{
...
void CTextureWindow::SetColorFilter( const color24* clr )
{
	g_Textures.ReSort( clr );
...
//-----------------------------------------------------------------------------
void CTextureWindow::SetSpecificList(CUsedTextureList *pList)
{

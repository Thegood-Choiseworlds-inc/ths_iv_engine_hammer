...
#define Four_Zeros DirectX::XMVectorZero()
#define Four_Ones DirectX::XMVectorSplatOne()
...
FORCEINLINE fltx4 ReplicateIX4( int i )
{
	...
	return _mm_castsi128_ps( _mm_shuffle_epi32( _mm_castps_si128( value ), 0 ) );
}
...
{
	return _mm_castsi128_ps( _mm_shuffle_epi32( _mm_castps_si128( a ), MM_SHUFFLE_REV( 0, 0, 0, 0 ) ) );
}

FORCEINLINE fltx4 SplatYSIMD( fltx4 const& a )
{
	return _mm_castsi128_ps( _mm_shuffle_epi32( _mm_castps_si128( a ), MM_SHUFFLE_REV( 1, 1, 1, 1 ) ) );
}

FORCEINLINE fltx4 SplatZSIMD( fltx4 const& a )
{
	return _mm_castsi128_ps( _mm_shuffle_epi32( _mm_castps_si128( a ), MM_SHUFFLE_REV( 2, 2, 2, 2 ) ) );
}

FORCEINLINE fltx4 SplatWSIMD( fltx4 const& a )
{
	return _mm_castsi128_ps( _mm_shuffle_epi32( _mm_castps_si128( a ), MM_SHUFFLE_REV( 3, 3, 3, 3 ) ) );
}
...
FORCEINLINE fltx4 RotateLeft( const fltx4& a )
{
	return _mm_castsi128_ps( _mm_shuffle_epi32( _mm_castps_si128( a ), MM_SHUFFLE_REV( 1, 2, 3, 0 ) ) );
}

// a b c d -> c d a b
FORCEINLINE fltx4 RotateLeft2( const fltx4& a )
{
	return _mm_castsi128_ps( _mm_shuffle_epi32( _mm_castps_si128( a ), MM_SHUFFLE_REV( 2, 3, 0, 1 ) ) );
}

// a b c d -> d a b c
FORCEINLINE fltx4 RotateRight( const fltx4& a )
{
	return _mm_castsi128_ps( _mm_shuffle_epi32( _mm_castps_si128( a ), MM_SHUFFLE_REV( 0, 3, 2, 1 ) ) );
}

// a b c d -> c d a b
FORCEINLINE fltx4 RotateRight2( const fltx4& a )
{
	return _mm_castsi128_ps( _mm_shuffle_epi32( _mm_castps_si128( a ), MM_SHUFFLE_REV( 1, 0, 3, 2 ) ) );
}
...
{
	return DirectX::XMVectorInBounds( a, b );
}
...
{
	return DirectX::XMVector4Equal( var, DirectX::XMVectorZero() );
}
...
{
	return DirectX::XMVectorReciprocalSqrt( a );
}
...
{
	return DirectX::XMVectorReciprocal( a );
}
...
{
	return DirectX::XMVectorClamp( in, min, max );
}
